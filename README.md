...
[**🚀 Getting Started**](#7-cài-đặt-nhanh) · [**📐 Architecture**](#2-kiến-trúc-hệ-thống) · [**📡 API**](#10-rest--websocket-api) · [**🎙️ Voice**](#11-voice-control) · [**🤖 LLM**](#12-llm-backend-openai-vs-ollama) · [**🐳 Deploy**](#16-triển-khai-docker--gpu-server--vpn)
...
2. [🏗️ Kiến trúc](#%EF%B8%8F-2-kiến-trúc-hệ-thống)
...
8. [▶️ Chạy](#%EF%B8%8F-8-chạy-hệ-thống)
9. [⚙️ Cấu hình](#%EF%B8%8F-9-cấu-hình--biến-môi-trường)
10. [📡 API](#-10-rest--websocket-api)
11. [🎙️ Voice](#%EF%B8%8F-11-voice-control)
...
flowchart TD
    ...
    E -- no --> A
    E -- yes --> F[⏸️ PAUSE pipeline<br/>📡 push DETECTION_FOUND]
    F --> G[🎤 Frontend bật mic<br/>+ hiện 3 nút action]
    G --> H{Doctor<br/>response}
    H -- "Bỏ qua" --> I[Log FP<br/>▶️ resume]
    H -- "Giải thích" --> J[💬 Stream Vision-LLM<br/>Paris + checklist]
    H -- "Xác nhận" --> K[💾 Save detection<br/>▶️ resume]
...
```mermaid
flowchart TB
    subgraph FE["🖥️ Next.js 16 Frontend · :3000"]
        direction LR
        FE1[Dashboard]
...
### Built with ❤️ for clinical workflow

...
Viết tiếng Việt, NHƯNG giữ thuật ngữ y khoa tiếng Anh trong ngoặc:
  ...
  ❌ "Viêm dạ dày HP" (thiếu phần EN cho thuật ngữ chuyên môn)
...
## QUY TẮC KHUYẾN NGHỊ (recommendations)
KHÔNG đề xuất số mảnh sinh thiết cụ thể, KHÔNG over-reach quyền chỉ định lâm sàng:
  ...
  ❌ "Sinh thiết 5 mảnh tại bờ và đáy"
  ❌ "Bắt đầu PPI 40mg × 8 tuần"
...
Differential chính (đầu danh sách) phải KHỚP với primary_dx.
